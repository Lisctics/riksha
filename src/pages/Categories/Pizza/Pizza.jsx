...
import Pizzaa from '../../../assets/Image/pizza_img.png'
...
export default function Pizza() {
  return (
    <div>
        <Tab_menu text={"Pizza"}/>
        <h1 className='m-20 ml-40 text-3xl font-bold'>Pizza</h1>
        <div className='m-10 ml-28'>
            <Card title={"Pizza"} text={"parijning shirin picheniyasi, kfgajs"} price={'10$'} image={Pizzaa}/>
        </div>
