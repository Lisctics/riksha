...
import Rooll from '../../../assets/Image/roll.png'
...
export default function Roll() {
  return (
    <div>
        <Tab_menu text={"Roll"}/>
        <h1 className='m-20 ml-40 text-3xl font-bold'>Roll</h1>
        <div className='m-10 ml-28'>
            <Card title={"Roll"} text={"parijning shirin picheniyasi, kfgajs"} price={'10$'} image={Rooll}/>
        </div>
