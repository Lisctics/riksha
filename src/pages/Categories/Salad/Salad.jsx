...
import Saalad from '../../../assets/Image/salad.jpg'
...
export default function Salad() {
  return (
    <div>
        <Tab_menu text={"Salad"}/>
        <h1 className='m-20 ml-40 text-3xl font-bold'>Salad</h1>
        <div className='m-10 ml-28'>
            <Card title={"Salad"} text={"parijning shirin picheniyasi, kfgajs"} price={'10$'} image={Saalad}/>
        </div>
