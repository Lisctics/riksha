...
import Dessert from '../../../assets/Image/dessert_1.jfif'
...
export default function Sale() {
  return (
    <div>
        <Tab_menu text={"Sale"}/>
        <h1 className='m-20 ml-40 text-3xl font-bold'>Sale</h1>
        <div className='m-10 ml-28'>
            <Card title={"Sale"} text={"parijning shirin picheniyasi, kfgajs"} price={'10$'} image={Dessert}/>
        </div>
