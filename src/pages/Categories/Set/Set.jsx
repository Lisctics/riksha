...
import Seet from '../../../assets/Image/set.jpg'
...
export default function Set() {
  return (
    <div>
        <Tab_menu text={"Set"}/>
        <h1 className='m-20 ml-40 text-3xl font-bold'>Set</h1>
        <div className='m-10 ml-28'>
            <Card title={"Set"} text={"parijning shirin picheniyasi, kfgajs"} price={'10$'} image={Seet}/>
        </div>
