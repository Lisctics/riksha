...
import Sooup from '../../../assets/Image/soup.jpg'
...
export default function Soup() {
  return (
    <div>
        <Tab_menu text={"Soup"}/>
        <h1 className='m-20 ml-40 text-3xl font-bold'>Soup</h1>
        <div className='m-10 ml-28'>
            <Card title={"Soup"} text={"parijning shirin picheniyasi, kfgajs"} price={'10$'} image={Sooup}/>
        </div>
