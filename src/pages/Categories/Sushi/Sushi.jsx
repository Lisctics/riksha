...
import Suushi from '../../../assets/Image/sushi1.jpg'
...
export default function Sushi() {
  return (
    <div>
        <Tab_menu text={"Dessert"}/>
        <h1 className='m-20 ml-40 text-3xl font-bold'>Sushi</h1>
        <div className='m-10 ml-28'>
            <Card title={"Sushi"} text={"parijning shirin picheniyasi, kfgajs"} price={'10$'} image={Suushi}/>
        </div>
