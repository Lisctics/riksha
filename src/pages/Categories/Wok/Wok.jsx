...
import Wook from '../../../assets/Image/wok.jpg'
...
export default function Wok() {
  return (
    <div>
        <Tab_menu text={"Wok"}/>
        <h1 className='m-20 ml-40 text-3xl font-bold'>Wok</h1>
        <div className='m-10 ml-28'>
            <Card title={"Wok"} text={"parijning shirin picheniyasi, kfgajs"} price={'10$'} image={Wook}/>
        </div>
